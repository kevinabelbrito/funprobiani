<div class="container">
    <div class="row">
        ...
        <div class="medium-8 small-16 columns" id="frontpage-il">
            ...
            <a href="<?= base_url() ?>personas/editar" class="button radius">Editar Datos</a>
        </div>
    </div>
</div>
<script>
    $(function(){
        ...
        $("#change_pw").validate({
            submitHandler:function(){
                var str = $("#change_pw").serialize();
                $.post("<?= base_url() ?>personas/cambio", str, success_data).error(error_data);
